...
import com.nishith.mediapicker.cropper.CropImageView.CropResult
...
import com.nishith.mediapicker.cropper.CropImageView.RequestSizeOptions
import java.io.File
 ...
 * question](http://stackoverflow.com/questions/32789027/android-m-camera-intent-permission-bug).
     ...
     * Result will be received in [onActivityResult(int, int, Intent)][Activity] and can be
     ...
     *
     * @param data result data intent as received in [onActivityResult(int, int,][Activity].
    ...
    class ActivityResult : CropResult, Parcelable {
        constructor(
         ...
         constructor(data: Parcel) : super(
            null,
            data.readParcelable<Parcelable>(Uri::class.java.classLoader) as Uri?,
            null,
            data.readParcelable<Parcelable>(Uri::class.java.classLoader) as Uri?,
            data.readSerializable() as Exception?,
            data.createFloatArray()!!,
            data.readParcelable<Parcelable>(Rect::class.java.classLoader) as Rect?,
            data.readParcelable<Parcelable>(Rect::class.java.classLoader) as Rect?,
            data.readInt(),
            data.readInt()
        )
